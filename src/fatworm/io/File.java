...
public class File {
	public static final long recordPageLen = 8;
	public static final long btreePageLen = 4;
	public static final long recordPageSize = recordPageLen * 1024;
	public static final long btreePageSize = btreePageLen * 1024;
